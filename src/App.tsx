      ...
      <section id="sample" className="menu-slider">
        <div className="slider" aria-label="Galería de platos, desplaza continuo">
          <div className="slider__track">
            <div className="slide"><img src="/images/image1.webp" alt="Rosca Angelical"/></div>
            <div className="slide"><img src="/images/image2.webp" alt="Trucha con Manzanas y Avellanas Tostadas"/></div>
            <div className="slide"><img src="/images/image3.webp" alt="Tofu y Verduras Sofritos"/></div>
            <div className="slide"><img src="/images/image4.webp" alt="Pollo al Ron"/></div>
            <div className="slide"><img src="/images/image5.webp" alt="Pierogi de Papa"/></div>
            <div className="slide"><img src="/images/image1.webp" alt="" aria-hidden="true"/></div>
            <div className="slide"><img src="/images/image2.webp" alt="" aria-hidden="true"/></div>
            <div className="slide"><img src="/images/image3.webp" alt="" aria-hidden="true"/></div>
            <div className="slide"><img src="/images/image4.webp" alt="" aria-hidden="true"/></div>
            <div className="slide"><img src="/images/image5.webp" alt="" aria-hidden="true"/></div>
          </div>
        </div>
      </section>
